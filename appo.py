...
# cursor.execute("create table if not exists customers(First_Name text,Last_Name text,id integer primary key AUTOINCREMENT  ,phone text, email text,check_in_date data,check_out_date data)")

# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Ahmed', 'Ali', '0101010101', 'ahmed.ali@example.com', '2024-12-01', '2024-12-05')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Mohamed', 'Hassan', '0102020202','mohamed.hassan@example.com', '2024-12-02', '2024-12-06')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Sara', 'Ibrahim', '0103030303', 'sara.ibrahim@example.com', '2024-12-03', '2024-12-07')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Hala', 'Youssef', '0104040404', 'hala.youssef@example.com', '2024-12-04', '2024-12-08')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Khaled', 'Omar', '0105050505', 'khaled.omar@example.com', '2024-12-05', '2024-12-09')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Mona', 'Adel','0106060606', 'mona.adel@example.com', '2024-12-06', '2024-12-10')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Eman', 'Salah','0107070707', 'eman.salah@example.com', '2024-12-07', '2024-12-11')"),
# cursor.execute("insert into customers (First_Name, Last_Name, phone, email, check_in_date, check_out_date) values('Tamer', 'Mahmoud', '0108080808','tamer.mahmoud@example.com', '2024-12-08', '2024-12-12')"),
